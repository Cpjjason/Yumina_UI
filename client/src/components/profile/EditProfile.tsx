...
import { Camera, Mail, User, Shield, Key, Bell, Globe, Save } from 'lucide-react';
  ...
  return (
    <div className="w-full max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-white/10 pb-6">
        <div>
          <h2 className="text-2xl font-bold text-main">Edit Profile</h2>
          <p className="text-sub mt-1">Manage your account settings and preferences.</p>
        </div>
        <Button 
          onClick={handleSave} 
          disabled={isSaving}
      ...
      <div className="flex flex-col md:flex-row gap-8">
        ...
        {/* Right Content Area */}
        <div className="flex-1 bg-white/[0.02] border border-white/5 rounded-2xl p-6 md:p-8">
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
                ...
                <div className="flex flex-col md:flex-row gap-6 items-start">
                  ...
                  <div className="flex-1 w-full">
                    <div className="relative group cursor-pointer w-full h-24 rounded-2xl overflow-hidden border-2 border-white/10 group-hover:border-gold/50 transition-colors">
                      ...
                      <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center">
                        <Camera className="w-6 h-6 text-white" />
                        <span className="ml-2 text-sm font-semibold text-white">Change Profile Banner</span>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <section className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input 
                      ...
                      className="bg-base/50 border-white/10 text-main focus-visible:ring-gold/50"
                    />
                  </div>
                  <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  <textarea 
                    id="bio"
                    className="flex w-full rounded-md border border-white/10 bg-base/50 px-3 py-2 text-sm text-main shadow-sm placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gold/50 disabled:cursor-not-allowed disabled:opacity-50 min-h-[100px] resize-y"
            ...
            <div className="space-y-8 animate-in fade-in duration-300">
              <section className="space-y-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between p-4 rounded-xl border border-white/10 bg-base/50">
                    ...
                    <Button variant="outline" size="sm" className="border-white/10 text-main hover:bg-white/5 hover:text-main">
                      Change
                    </Button>
                  </div>
          ...
          {(activeTab === 'notifications' || activeTab === 'privacy') && (
            <div className="flex flex-col items-center justify-center py-20 text-center animate-in fade-in duration-300">
              ...
              <div className="w-full max-w-md mt-8 space-y-4 text-left">
                {[1, 2, 3].map((i) => (
                  <div key={i} className="flex items-center justify-between p-4 rounded-xl border border-white/10 bg-base/50">
                    <div>
